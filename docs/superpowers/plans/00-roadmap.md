...
| 4 | **Tasks + Projects (Kanban)** — projects (name/desc/active), kanban (todo/in-progress/completed/blocked), task fields + audit log, doc↔project↔domain relations. | in-progress | [spec](../specs/2026-06-03-tasks-projects.md) | [plan](2026-06-03-tasks-projects.md) | — |
