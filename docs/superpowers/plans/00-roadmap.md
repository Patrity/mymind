...
| 11 | **Sessions view** — browse raw CC/Hermes transcripts + token usage / message count / tool-use stats. | in-progress | [spec](../specs/2026-06-03-sessions-view.md) | [plan](2026-06-03-sessions-view.md) | — |
