...
mymind_hash: c8bc8db1f50cf3244df8b6dc2bb5604bedc2087bc2a9abfaf2c086e7c9a16c15
---
...
| `app/components/voice/PresetRail.vue`, `DesignPane.vue` (+ its three `Design*` children), `SpeakPane.vue` | The studio's three panels (cycle 61; the design pane split into children in cycle 67) — see [voice-studio.md](voice-studio.md) |
