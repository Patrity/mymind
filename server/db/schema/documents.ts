...
export const documents = pgTable('documents', {
  ...
  // Generated by Postgres (see the doc_content_hash migration) so no writer can leave it stale —
  // including any future writer that bypasses updateDoc. (The one that used to, image-enrich.ts's
  // document spin-off, now routes through updateDoc; the generated column is what made its raw
  // write harmless while it lasted.)
