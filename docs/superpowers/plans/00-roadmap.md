...
> Also tracked in the backlog (not yet cycled): GitHub-commits→memory, session-summarization worker, video→webm, EXIF scrub, bridget data migration, and assorted tech-debt. (Image semantic search shipped in cycle 20.) See [`docs/BACKLOG.md`](../../BACKLOG.md).
